...
public class ProjectCRUDContactsAdapter extends RecyclerView.Adapter<ProjectCRUDContactsAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.card_crud_contacts, parent, false);
